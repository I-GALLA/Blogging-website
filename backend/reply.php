...
<body class="nav-fixed">
 ...
 <div id="layoutSidenav">
  ...
  if (isset($_POST['response'])) {
   $id = $_POST['id'];
   $url = "http://localhost/amdi/backend/reply.php?id=" . $id;
   header("Location: {$url}");
  }
  ?>
      ...
      <div class="card-body">
       ...
       <form action="reply.php?id=<?php echo $_GET['id']; ?>" method="POST">
        ...
        <div class="form-group">
         ...
         <input name="user-name" value="<?php echo $user_name; ?>" class="form-control" id="user-name" type="text" placeholder="User name ..." readonly="true" value="Imane Galla" />
        </div>
